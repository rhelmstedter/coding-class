...
I created a coding project. When I was first learning out to webscrape, I became very excited. I thought about how I could use it in the classroom and see if I could connect it to other disciplines. Part of the vision of the program we ran at my previous school was to incorporate computer science into all core classes. This is one possible way to do that. 
